...
from lib.env import MODEL_DIR, MODEL_NAME, MODEL_TIMESTAMP, SAMPLE_RATE
...
def save_model(
    ...
    latest_model_filepath = os.path.join(MODEL_DIR, f"{MODEL_NAME}-latest.pkl")
    timestamped_model_filepath = os.path.join(MODEL_DIR, f"{MODEL_NAME}-{MODEL_TIMESTAMP}.pkl")
