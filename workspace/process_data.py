...
from lib.env import MESSAGES_FILEPATH, CATEGORIES_FILEPATH
...
def save_data(df, category_colnames, engine):
    ...
    # NB Not needed if using sqlite. TODO not sure if i will bother abstracting this, as i have no intention of siupporting sqllite aside from submission purposes
